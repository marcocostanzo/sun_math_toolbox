...
using namespace std;
    ...
    Quaternion::Quaternion( double s, const Vector<3>& v ):
        _s(s),
        _v(v)
        {}
    ...
    Quaternion::Quaternion( const Vector<4>& q_vec ):
        Quaternion(q_vec[0] , q_vec.slice(1,3))
        {}
